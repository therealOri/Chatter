...
ChatterEye grabs chat messages from all servers you/your bot is in and from all of the channels it can see. Then sends/Logs all of it into chat_logs.db.
